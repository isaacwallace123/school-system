...
public class EntityModelMapper {
    public static CourseResponseModel toModel(Course course) {
        return new CourseResponseModel(course.getCourseId(), course.getCourseNumber(), course.getCourseName(), course.getNumHours(), course.getNumCredits(), course.getDepartment());
    }
